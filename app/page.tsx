export default function Home() {
  return (
    <>
      <div className="fixed left-0 top-0 -z-10 h-full w-full bg-vtuber bg-no-repeat opacity-15" />
      <div className="absolute left-0 top-0 flex h-full w-full items-center justify-center">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <a
            href="https://github.com/rl404/hololive"
            target="_blank"
            className="size-6 hover:opacity-60"
          >
